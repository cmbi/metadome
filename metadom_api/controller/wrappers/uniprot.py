...
@author: laurens
'''
from metadom_api.controller.wrappers.blast import run_blast, interpret_blast_as_uniprot
from metadom_api.controller.wrappers.gencode import retrieveSwissProtIDs,\
    NoSwissProtEntryFoundException
from metadom_api.default_settings import UNIPROT_SPROT_CANONICAL, UNIPROT_TREMBL,\
