...
def create_annotated_meta_domain(domain_id, domain_dataset, minimal_merged_meta_domain_ExAC_frequency,  merged_meta_domain_missense_only): 
    ...
    logging.getLogger(LOGGER_NAME).info("Starting annotation of the '"+domain_id+"' domains with ExAC and HGMD information")
    ...
    logging.getLogger(LOGGER_NAME).info("Finished annotating the '"+domain_id+"' domains with ExAC and HGMD information: '"+str(len(domain_of_interest_domain_data)-len(ignore_list_of_indices)) +"' domain occurrences of the original '"+str(len(domain_of_interest_domain_data))+"' occurrences remained")
    ...
    logging.getLogger(LOGGER_NAME).info("Starting creating a merged domain consisting of HGMD, ExAC and Reference information for the '"+domain_id+"' 'meta'-domain")
    ...
    logging.getLogger(LOGGER_NAME).info("Finished creating a merged domain consisting of HGMD, ExAC and Reference information for the '"+domain_id+"' 'meta'-domain")
...
#     create_annotated_meta_domain('PF00048', data, FILTER_ON_MINIMAL_EXAC_FREQUENCY, FILTER_ON_MISSENSE_ONLY)
    create_annotated_meta_domain('PF00153', data, FILTER_ON_MINIMAL_EXAC_FREQUENCY, FILTER_ON_MISSENSE_ONLY)
#     create_annotated_meta_domain('PF00008', data, FILTER_ON_MINIMAL_EXAC_FREQUENCY, FILTER_ON_MISSENSE_ONLY)
#     create_annotated_meta_domain('PF00089', data, FILTER_ON_MINIMAL_EXAC_FREQUENCY, FILTER_ON_MISSENSE_ONLY)
