...
def fill_with_test_data():
    ...
    db.session.add(_mapping_pacs1_1)
    db.session.add(_mapping_pacs1_2)
    db.session.add(_mapping_pacs2_1)
    db.session.add(_chrompos_pacs1_1)
    db.session.add(_chrompos_pacs1_2)
    db.session.add(_chrompos_pacs2_1)
    db.session.add(_gene_pacs1)
    db.session.add(_gene_pacs2)
    db.session.add(_protein_pacs1)
    db.session.add(_protein_pacs2)
    db.session.add(_pfam_domain_pacs1_1)
    db.session.add(_pfam_domain_pacs2_1)
    db.session.commit()