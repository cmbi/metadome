...
class MetaDomain(object):
    ...
    def __init__(self, domain_id):
        ...
        if domain_id.startswith('PF'):
            ...
            self.mappings_per_consensus_pos, self.consensus_pos_per_protein, self.n_instances, self.gencode_transcription_id_per_gene_id, self.protein_ac_per_protein_id = generate_pfam_alignment_mappings(self.domain_id)
