...
import logging
# import os
# from metadome.default_settings import PRE_BUILD_VISUALIZATION_DIR,\
#     PRE_BUILD_VISUALIZATION_FILE_NAME, SLIDING_WINDOW_SIZE,\
...
#     """
# #     _log.info(get_celery_worker_status())
#     
#     task = None
# #     if job_name == 'create':
...
#     return mock_ptpn11()
# #     return jsonify(mockup_tol_and_metadom())
...
#     visualization_path = PRE_BUILD_VISUALIZATION_DIR + transcript_id + '/' + PRE_BUILD_VISUALIZATION_FILE_NAME
...
#         region_positional_annotation = compute_tolerance_landscape(gene_region, SLIDING_WINDOW_SIZE, ALLELE_FREQUENCY_CUTOFF)
#         
